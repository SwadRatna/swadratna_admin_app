...
interface CustomersRepository {
    suspend fun list(page: Int?, limit: Int?, status: String?, search: String?, fromDate: String? = null, toDate: String? = null): Result<CustomerListResponse>
...
class CustomersRepositoryImpl @Inject constructor(
    ...
    override suspend fun list(page: Int?, limit: Int?, status: String?, search: String?, fromDate: String?, toDate: String?): Result<CustomerListResponse> {
        return try {
            Result.success(api.listCustomers(page, limit, status, search, fromDate, toDate))
        } catch (e: Exception) {
